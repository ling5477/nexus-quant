package com.guidinglight.nexusquant.trading.application.safety.service;

import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFactBundle;
import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode;
import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentRequest;
import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentResult;
import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentStatus;

import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.BACKUP_RESTORE_NOT_PROVEN;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.HUMAN_REVIEW_EVIDENCE_CONFLICT;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.HUMAN_REVIEW_EVIDENCE_MISSING;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.HUMAN_REVIEW_EVIDENCE_STALE;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.INCIDENT_DRILL_INCOMPLETE;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.KILL_SWITCH_ENGAGED;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.KILL_SWITCH_STORAGE_FAILURE;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.KILL_SWITCH_UNKNOWN;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.LOCAL_SOAK_NOT_PROVEN;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.PERSISTENCE_RETENTION_NOT_PROVEN;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.REAL_READONLY_SOAK_CREDENTIAL_REQUIRED;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFindingCode.REAL_READONLY_SOAK_NOT_EVALUATED;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentStatus.BLOCKED;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentStatus.NOT_EVALUATED;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentStatus.PASS;
import static com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentStatus.UNKNOWN;
...
import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFactBundle.HumanReviewEvidence;
import com.guidinglight.nexusquant.trading.application.safety.model.OperationalSafetyAssessmentFactBundle.HumanReviewEvidenceStatus;
