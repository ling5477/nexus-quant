...
import com.guidinglight.nexusquant.research.port.BacktestPublishRecordRepository;
...
public class BacktestPublishService {
    ...
    public BacktestPublishRecord publish(BacktestPublishRequest request) {
        ...
        if (backtestRun.status() != com.guidinglight.nexusquant.research.model.BacktestRunStatus.SUCCEEDED) {
    ...
    private BacktestPublishRecord failPublish(
            ...
            com.guidinglight.nexusquant.research.model.BacktestRun backtestRun,
