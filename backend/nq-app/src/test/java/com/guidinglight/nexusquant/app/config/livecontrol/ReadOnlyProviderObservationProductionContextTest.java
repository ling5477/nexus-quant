 ...
 */
@ActiveProfiles("scoped-okx-private-readonly")
@SpringBootTest(
...
@ContextConfiguration(
        classes = ReadOnlyProviderObservationProductionContextTest.Probes.class,
        initializers = ReadOnlyProviderObservationProductionContextTest.NoOkxOutboundInitializer.class
)
...
class ReadOnlyProviderObservationProductionContextTest {
