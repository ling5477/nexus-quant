...
- 本批只接受 Phase7-D strict canonical archive 与 pre-tag closeout，并同步 current authority；不替代 Phase7-A/B/C immutable pair、taxonomy normalization pair 或任何历史 technical pair。Phase7-E、promotion、freeze、tag 与 release 均未执行；production connection/mutation、LIVE、真实 provider、生产数据库和资金操作仍无授权。
