...
- **NQ-GATEL-1-EXCHANGE-ADAPTER-CONTRACT-REVIEW = CONDITIONAL PASS / DOCS-CONTRACT ONLY**（2026-06-22）：review 文档 `GATEL_1_EXCHANGE_ADAPTER_CONTRACT_REVIEW.md` 已落档。P0=0；P1=4（Binance default endpoint、进程 credential、`rawPayload`、stub success marker）；现有合同不得标记 future-real-ready。下一步 GateL-1A review freeze，再按 1B capability / 1C error / 1D No-Real hardening plan / 1E checklist refinement 推进。**GateL implementation NOT STARTED；真实交易所未授权。**
