...
- 当前治理动作：`NQ-GATEW-3-READ-ONLY-RECONCILIATION-SECURITY-RISK-REVIEW-ATTEMPT-01`。只允许 read-only reconciliation/security/risk review；不得修改 preview business implementation，不得初始化 GateW-4 或 GateW Freeze。
