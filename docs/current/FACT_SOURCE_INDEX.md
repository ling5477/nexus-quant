...
- Shadow Run overview backend read model 已实现；仍不得写成 write API、runner start endpoint、scheduler、frontend page、GateS 全域 validation overview、Strategy Validation approval、trading authorization 或 LIVE ready。
