...
9. [NQ_DOCS_ARCHIVE_RULE_HARDENING_AND_RESIDUAL_MOVE_PLAN.md](NQ_DOCS_ARCHIVE_RULE_HARDENING_AND_RESIDUAL_MOVE_PLAN.md)：archive governance hardening 与 GateR/S/T residual move plan；只定义后续 move batch，不移动文件。
...
18. [../gates/gate-s/README.md](../gates/gate-s/README.md)：GateS 历史归档入口。
...
- GateS residual：`GATES_0_PLAN.md`、`GATES_1_READ_MODEL_WO.md`、`GATES_1_FRONTEND_OVERVIEW_WO.md`、`GATES_FREEZE_READINESS_REVIEW.md`。
- GateT residual：`GATET_PLAN.md`、`GATET_1_SHADOW_VALIDATION_WORKFLOW_WO.md`、`GATET_2_CONSISTENCY_EVIDENCE_REFINEMENT_WO.md`、`GATET_3_INCIDENT_REPLAY_REVIEW_WORKFLOW_WO.md`、`GATET_4_PYTHON_EVALUATION_ARTIFACT_BINDING_PREVIEW_WO.md`、`GATET_5_VALIDATION_OPERATIONS_WORKBENCH_WO.md`、`GATET_6_RUNTIME_SCHEDULING_READINESS_WO.md`、`GATET_FREEZE_READINESS_REVIEW.md`。

计划入口：[NQ_DOCS_ARCHIVE_RULE_HARDENING_AND_RESIDUAL_MOVE_PLAN.md](NQ_DOCS_ARCHIVE_RULE_HARDENING_AND_RESIDUAL_MOVE_PLAN.md)。后续每个 move batch 必须把已移动 residual 从本节移除，并把目标 `docs/gates/<gate>/source/` 或 `docs/archive/**` 路径记录为 historical evidence。
