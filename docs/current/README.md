...
- `NQ_CI_NO_OUTBOUND_GUARD_PLAN.md`：Batch 3 no-outbound guard plan / implementation 文件；当前为 IMPLEMENTED / PENDING FIRST CI RUN，后续只能进入 Batch 3 first-run review、Batch 3 first-run fix，或暂停 CI 线。
