...
- [NQ_CI_SECURITY_BATCH_5B_ENV_PLAN.md](NQ_CI_SECURITY_BATCH_5B_ENV_PLAN.md)：Batch 5B-ENV env/secret/no-outbound planning（plan ACCEPTED / READY FOR IMPLEMENTATION；implementation NOT STARTED；5B-SMOKE BLOCKED BY 5B-ENV）。
