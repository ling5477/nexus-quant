...
- 当前唯一动作是 `NQ-GATEY-6C-COMMIT-AND-PUSH`；仅允许提交已接受的 GateY-6C scoped credential/IP/private permission read-only verification 变更，不授权再次 probe、PLACE、CANCEL、mutation、micro-live、第一笔真实订单或 LIVE，exact transition 以 [STATUS.md](STATUS.md) 为准。
