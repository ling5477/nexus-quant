...
- Attempt-12=`NOT_CREATED / AUTHORIZED`，production deployment=`NOT_STARTED`。该 authority 只允许受控 preparation/start；不表示生产已连接、release 已部署、OKX 已调用、RunId/worker/heartbeat/hash chain/168h clock 已建立。
