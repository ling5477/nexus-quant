...
- 当前唯一动作是 `NQ-GATEY-3-EXECUTION-INTENT-RECEIPT-FAKE-EXCHANGE-COMMIT-AND-PUSH`；只允许精确暂存、提交并推送已接受的 fake/local execution 变更，不包含真实交易所、真实 PLACE/CANCEL、production worker 或 LIVE，micro-live 未授权，exact transition 以 [STATUS.md](STATUS.md) 为准。
