...
- 当前唯一动作是 `NQ-GATEY-3-EXECUTION-INTENT-RECEIPT-FAKE-EXCHANGE-IMPLEMENTATION`；只允许实现 ExecutionIntent/ExecutionReceipt、fake exchange、幂等、claim/lease、crash/UNKNOWN 与本地 reconciliation，不包含真实交易所或真实 PLACE/CANCEL，micro-live 未授权，exact transition 以 [STATUS.md](STATUS.md) 为准。
