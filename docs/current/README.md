...
- 当前唯一动作是 `NQ-GATEY-6F-MINIMAL-LIVE-PILOT-END-TO-END-BLOCKED`；implementation CI已绿，release只完成inactive immutable install和V41 backup，服务器SSH banner持续超时。未调用migration/activation/credential/OKX/PLACE/CANCEL；精确边界以 [STATUS.md](STATUS.md) 为准。
