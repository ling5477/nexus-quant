...
- `NQ_CI_ARTIFACT_LOG_REDACTION_PLAN.md`：Batch 4C artifact / log redaction proof 当前 planning 文件；PLAN ONLY / NOT IMPLEMENTED，下一步只允许 Batch 4C-A plan review、Batch 4C plan fix、Batch 4C-B pre-upload redaction gate minimal implementation，或暂停 CI 线；复用 Batch 4B pattern，不做 Batch 4F / Batch 5。
