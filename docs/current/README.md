...
- `NQ_CI_NO_OUTBOUND_GUARD_PLAN.md`：Batch 3 no-outbound guard plan / implementation 文件；当前为 FIRST GREEN RUN CONFIRMED（run `27634370657`），后续只能进入 Batch 3E freeze review、Batch 3 parity/hygiene follow-up，或暂停 CI 线；不得直接写 FROZEN / ACCEPTED。
