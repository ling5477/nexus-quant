...
- 当前唯一动作是 `NQ-GATEY-2-LIVE-SESSION-FACT-MODEL-COMMIT-AND-PUSH`；只允许提交并推送已接受的 GateY-2 LIVE control-plane facts 与 V39，不包含真实 exchange execution，micro-live 未授权，exact transition 以 [STATUS.md](STATUS.md) 为准。
