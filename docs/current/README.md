...
- Attempt-10=`FAILED / STOPPED`，production deployment=`STOPPED`。唯一 RunId `gatew-soak-20260801T102353Z-932e26a4` 已 terminalize；worker 实际从未启动，OKX calls=`0`，first heartbeat/hash chain/168h clock 均不存在，current/unit links 已回滚。当前 `NQ-GATEW-ATTEMPT-10-PREPARATION-AND-START-BLOCKED` 不授权重试、复用 RunId、Attempt-11、remediation、LIVE/交易写侧或 freeze/archive/tag；新路线须由独立 authority 决策定义。
