...
- [command owner](../../../backend/nq-core/src/main/java/com/guidinglight/nexusquant/trading/application/service/OrderCommandService.java)、[transaction owner](../../../backend/nq-core/src/main/java/com/guidinglight/nexusquant/trading/application/service/OrderCommandWriteService.java)、[gateway](../../../backend/nq-scheduler/src/main/java/com/guidinglight/nexusquant/scheduler/integration/AdapterBackedTradingVenueGateway.java)、[OCC repository](../../../backend/nq-infra/src/main/java/com/guidinglight/nexusquant/trading/infra/jdbc/JdbcOrderRepository.java)。
- [recovery](../../../backend/nq-scheduler/src/main/java/com/guidinglight/nexusquant/scheduler/recovery/OkxRecoveryService.java)、[scheduler wiring](../../../backend/nq-scheduler/src/main/java/com/guidinglight/nexusquant/scheduler/validationevidence/config/ValidationEvidenceSchedulerConfiguration.java)、[scheduler entrypoint](../../../backend/nq-scheduler/src/main/java/com/guidinglight/nexusquant/scheduler/validationevidence/scheduling/ValidationEvidenceScheduler.java)、[read-only refresh](../../../backend/nq-scheduler/src/main/java/com/guidinglight/nexusquant/scheduler/validationevidence/service/ValidationEvidenceRefreshService.java)、[advisory lock](../../../backend/nq-infra/src/main/java/com/guidinglight/nexusquant/scheduler/infra/lock/PostgresAdvisorySchedulerExecutionLock.java)。
