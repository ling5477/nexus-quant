...
事件契约统一归口 `nq-contracts`，详见 `./CONTRACTS.md`：
...
模块边界与依赖方向详见：`./MODULES.md`。

## 附录 B：关键策略文档

- 数值精度：`./NUMERIC_POLICY.md`
- 事件演进规则：`./EVOLUTION_RULES.md`
- DB 结构说明：`./DB_SCHEMA.md`
- 恢复/回放：`./RECOVERY_RUNBOOK.md`
- Roadmap：`./ROADMAP.md`
