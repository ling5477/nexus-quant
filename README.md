...
- 当前唯一动作是 `NQ-GATEY-1-LIVE-SESSION-DATA-MODEL-WORK-ORDER-IMPLEMENTATION`；只允许形成 GateY-1 正式 implementation work order，不得创建 migration 或 runtime，micro-live 未授权，exact transition 以 [STATUS.md](docs/current/STATUS.md) 为准。
