...
- 当前唯一动作是 `NQ-GATEY-PLAN-COMMIT-AND-PUSH`；只允许提交并推送 GateY plan 文档，不表示 implementation 或 micro-live 已获授权，exact transition 以 [STATUS.md](docs/current/STATUS.md) 为准。
