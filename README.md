...
- `docs/current/NQ_GATEO_O4_MARKETDATA_QUALITY_UI_PLAN.md`：GateO O-4 MarketData Quality UI planning-only 状态入口；记录 `/marketdata` 页面复用建议、readiness API 字段映射、状态/文案/测试策略、no-trading 边界和 O-4A..O-4E 批次
