...
- `docs/current/GATEO_PLAN.md`：GateO O-0 planning-only baseline、O-1 controlled public outbound guard frozen baseline 与后续 O-2/O-3/O-4/O-5/O-FREEZE 计划；O-1 已 PASS / ACCEPTED / FROZEN，O-5 manual real public smoke 仍 NOT STARTED
