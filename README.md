...
- `docs/current/TESTING.md`：验证记录；记录 GateT-1 backend / frontend build 与 targeted smoke 等当前验证事实。
- `docs/current/WORKLOG.md`：工作记录；记录 GateT-1 frontend overview 实现范围、边界和下一步。
