...
- `docs/current/NQ_GATEO_O5_MANUAL_PUBLIC_OUTBOUND_SMOKE_PLAN.md`：GateO O-5 manual public outbound smoke planning、O-5B execution result、O-5C result review、O-5D DataOrigin decision 与 O-5E freeze review 状态入口；记录前置条件、manual profile、feature flag、public allowlist、private denylist、证据脱敏、失败降级、DataOrigin 后置决策和 O-5A..O-5E / O-FREEZE 路线；O-5A 已 PASS / ACCEPTED；O-5B-R1 runner binding implementation 已 IMPLEMENTED / SELF-REVIEWED / COMMITTED；O-5B-R2 runner binding review 已 PASS / ACCEPTED；O-5B manual smoke result 已 COMPLETED / RESULT REVIEWED / ACCEPTED；O-5C 已 PASS / ACCEPTED；O-5D 已 PASS / ACCEPTED；O-5E 已 PASS / ACCEPTED；O-5 final status 已 FROZEN / ACCEPTED
- `docs/current/NQ_GATEO_O5E_MANUAL_PUBLIC_OUTBOUND_SMOKE_FREEZE_REVIEW.md`：GateO O-5E manual public outbound smoke freeze review；结论为 PASS / ACCEPTED，O-5 final status = FROZEN / ACCEPTED；O-FREEZE 仍 NOT STARTED；GateO stage 仍 NOT COMPLETED；O-5D-R1 DataOrigin implementation 仍 NOT STARTED / optional next branch
- `docs/current/NQ_GATEO_O5D_DATAORIGIN_PUBLIC_OUTBOUND_DECISION.md`：GateO O-5D DataOrigin.PUBLIC_OUTBOUND decision review；结论为 PASS / ACCEPTED，decision = `ALLOW_FUTURE_IMPLEMENTATION`；只允许后续单独实现公开行情只读外联来源诊断语义，不表示 trading authorization / LIVE ready / permission granted / credential configured / provider ready for trading
